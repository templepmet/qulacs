...
void test_single_qubit_named_gate(UINT n, std::string name,
    std::function<void(UINT, void*, ITYPE, void*, UINT, bool)> func,
    Eigen::MatrixXcd mat) {
    ...
    for (int idx = 0; idx < ngpus; ++idx) {
        ...
        for (UINT rep = 0; rep < max_repeat; ++rep) {
            for (UINT i = 0; i < n; ++i) {
                ...
                func(target, state, dim, stream_ptr, idx, true);
                test_state =
...
TEST(UpdateTest, XGate) {
    ...
    mat << 0, 1, 1, 0;
    void (*func)(UINT, void*, ITYPE, void*, UINT, bool) = &X_gate_host;
    test_single_qubit_named_gate(6, "XGate", func, mat);
}
TEST(UpdateTest, YGate) {
    Eigen::MatrixXcd mat(2, 2);
    mat << 0, -1.i, 1.i, 0;
    void (*func)(UINT, void*, ITYPE, void*, UINT, bool) = &Y_gate_host;
...
TEST(UpdateTest, ZGate) {
    ...
    Eigen::MatrixXcd mat(2, 2);
    mat << 1, 0, 0, -1;
    void (*func)(UINT, void*, ITYPE, void*, UINT, bool) = &Z_gate_host;
...
TEST(UpdateTest, HGate) {
    ...
    mat << 1, 1, 1, -1;
    mat /= sqrt(2.);
    void (*func)(UINT, void*, ITYPE, void*, UINT, bool) = &H_gate_host;
...
TEST(UpdateTest, SGate) {
    ...
    Eigen::MatrixXcd mat(2, 2);
    mat << 1, 0, 0, 1.i;
    void (*func)(UINT, void*, ITYPE, void*, UINT, bool) = &S_gate_host;
    test_single_qubit_named_gate(n, "SGate", func, mat);
    void (*func2)(UINT, void*, ITYPE, void*, UINT, bool) = &Sdag_gate_host;
...
TEST(UpdateTest, TGate) {
    ...
    void (*func)(UINT, void*, ITYPE, void*, UINT, bool) = &T_gate_host;
    test_single_qubit_named_gate(n, "TGate", func, mat);
    void (*func2)(UINT, void*, ITYPE, void*, UINT, bool) = &Tdag_gate_host;
...
TEST(UpdateTest, sqrtXGate) {
    ...
    void (*func)(UINT, void*, ITYPE, void*, UINT, bool) = &sqrtX_gate_host;
    test_single_qubit_named_gate(n, "SqrtXGate", func, mat);
    void (*func2)(UINT, void*, ITYPE, void*, UINT, bool) = &sqrtXdag_gate_host;
...
TEST(UpdateTest, sqrtYGate) {
    ...
    Eigen::MatrixXcd mat(2, 2);
    mat << 0.5 + 0.5i, -0.5 - 0.5i, 0.5 + 0.5i, 0.5 + 0.5i;
    void (*func)(UINT, void*, ITYPE, void*, UINT, bool) = &sqrtY_gate_host;
    test_single_qubit_named_gate(n, "SqrtYGate", func, mat);
    void (*func2)(UINT, void*, ITYPE, void*, UINT, bool) = &sqrtYdag_gate_host;
    test_single_qubit_named_gate(n, "SqrtYGate", func2, mat.adjoint());
}

void test_projection_gate(
    std::function<void(UINT, void*, ITYPE, void*, UINT, bool)> func,
    std::function<double(UINT, void*, ITYPE, void*, UINT)> prob_func,
    Eigen::MatrixXcd mat) {
    const UINT n = 6;
    const ITYPE dim = 1ULL << n;
    ...
    for (int idx = 0; idx < ngpus; ++idx) {
        ...
        for (UINT rep = 0; rep < max_repeat; ++rep) {
            ...
            func(target, state, dim, stream_ptr, idx, true);
            ASSERT_NEAR(state_norm_squared_host(state, dim, stream_ptr, idx),
                prob, eps);
            normalize_host(prob, state, dim, stream_ptr, idx, true);
            ...
            state_equal_gpu(
                state, test_state, dim, "Projection gate", stream_ptr, idx);
        }
        release_quantum_state_host(state, idx);
        release_cuda_stream_host(stream_ptr, 1, idx);
    }
...
TEST(UpdateTest, ProjectionAndNormalizeTest) {
    ...
    P0 << 1, 0, 0, 0;
    P1 << 0, 0, 0, 1;
    void (*func1)(UINT, void*, ITYPE, void*, UINT, bool) = &P0_gate_host;
...
TEST(UpdateTest, SingleQubitRotationGateTest) {
    ...
    for (int idx = 0; idx < ngpus; ++idx) {
        ...
        Eigen::VectorXcd test_state =
            copy_cpu_from_gpu(state, dim, stream_ptr, idx);
        typedef std::tuple<
            std::function<void(UINT, double, void*, ITYPE, void*, UINT, bool)>,
            Eigen::MatrixXcd, std::string>
            testset;
        std::vector<testset> test_list;
        void (*func)(UINT, double, void*, ITYPE, void*, UINT, bool) =
            &RX_gate_host;
        ...
        for (UINT rep = 0; rep < max_repeat; ++rep) {
            for (auto tup : test_list) {
                ...
                func(target, angle, state, dim, stream_ptr, idx, true);
                test_state =
...
void test_two_qubit_named_gate(UINT n, std::string name,
    std::function<void(UINT, UINT, void*, ITYPE, void*, UINT, bool)> func,
    ...
    for (int idx = 0; idx < ngpus; ++idx) {
        ...
        for (UINT rep = 0; rep < max_repeat; ++rep) {
            for (UINT i = 0; i + 1 < n; i += 2) {
                ...
                func(control, target, state, dim, stream_ptr, idx, true);
...
TEST(UpdateTest, CNOTGate) {
    const UINT n = 4;
    void (*func)(UINT, UINT, void*, ITYPE, void*, UINT, bool) = &CNOT_gate_host;
    test_two_qubit_named_gate(
        n, "CNOT", func, get_eigen_matrix_full_qubit_CNOT);
}

TEST(UpdateTest, CZGate) {
    const UINT n = 4;
    void (*func)(UINT, UINT, void*, ITYPE, void*, UINT, bool) = &CZ_gate_host;
    test_two_qubit_named_gate(n, "CZ", func, get_eigen_matrix_full_qubit_CZ);
}

TEST(UpdateTest, SWAPGate) {
    const UINT n = 4;
    void (*func)(UINT, UINT, void*, ITYPE, void*, UINT, bool) = &SWAP_gate_host;
    test_two_qubit_named_gate(
        n, "SWAP", func, get_eigen_matrix_full_qubit_SWAP);
}
