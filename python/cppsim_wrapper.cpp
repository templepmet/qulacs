...
PYBIND11_MODULE(qulacs_core, m) {
    ...
    py::class_<GeneralQuantumOperator>(m, "GeneralQuantumOperator")
        ...
        .def("add_operator",
            (void(GeneralQuantumOperator::*)(const PauliOperator *)) &
        ...
        .def(
            ...
            pybind11::return_value_policy::take_ownership, "Get Pauli term",
            py::arg("index"))
    ...
    py::class_<HermitianQuantumOperator, GeneralQuantumOperator>(
        ...
        .def("get_transition_amplitude",
            ...
            "Get transition amplitude", py::arg("state_bra"),
            py::arg("state_ket"))
        //.def_static("get_split_Observable",
        //&(HermitianQuantumOperator::get_split_observable));
    ...
    py::class_<QuantumState, QuantumStateBase>(m, "QuantumState")
        ...
        .def("set_computational_basis", &QuantumState::set_computational_basis,
            "Set state to computational basis", py::arg("index"))
        .def("set_Haar_random_state",
            (void(QuantumState::*)(void)) & QuantumState::set_Haar_random_state,
            "Set Haar random state")
        .def("set_Haar_random_state",
            (void(QuantumState::*)(UINT)) & QuantumState::set_Haar_random_state,
            py::arg("seed"))
        ...
        .def("load",
            (void(QuantumState::*)(const std::vector<CPPCTYPE> &)) &
                QuantumState::load,
            py::arg("state"))
        ...
        .def("sampling",
            (std::vector<ITYPE>(QuantumState::*)(UINT)) &
                QuantumState::sampling,
            "Sampling measurement results", py::arg("count"))
        .def("sampling",
            (std::vector<ITYPE>(QuantumState::*)(UINT, UINT)) &
                QuantumState::sampling,
        ...
        .def(
            "get_qubit_count",
            [](const QuantumState &state) -> unsigned int {
                return (unsigned int)state.qubit_count;
            },
            "Get qubit count")
    ...
    m.def(
        "StateVector",
        [](const unsigned int qubit_count) {
    ...
    py::class_<DensityMatrix, QuantumStateBase>(m, "DensityMatrix")
        ...
        .def("set_computational_basis", &DensityMatrix::set_computational_basis,
            "Set state to computational basis", py::arg("index"))
        .def("set_Haar_random_state",
            (void(DensityMatrix::*)(void)) &
                DensityMatrix::set_Haar_random_state,
            "Set Haar random state")
        .def("set_Haar_random_state",
            (void(DensityMatrix::*)(UINT)) &
                DensityMatrix::set_Haar_random_state,
            py::arg("seed"))
        ...
        .def("load",
            (void(DensityMatrix::*)(const QuantumStateBase *)) &
                DensityMatrix::load,
            "Load quantum state vector or density matrix", py::arg("state"))
        .def("load",
            (void(DensityMatrix::*)(const std::vector<CPPCTYPE> &)) &
                DensityMatrix::load,
            py::arg("state"))
        .def("load",
            (void(DensityMatrix::*)(const ComplexMatrix &)) &
                DensityMatrix::load,
            py::arg("state"))
        ...
        .def("to_string", &QuantumState::to_string, "Get string representation")
        .def("sampling",
            (std::vector<ITYPE>(DensityMatrix::*)(UINT)) &
                DensityMatrix::sampling,
            "Sampling measurement results", py::arg("count"))
        .def("sampling",
            (std::vector<ITYPE>(DensityMatrix::*)(UINT, UINT)) &
                DensityMatrix::sampling,
            py::arg("count"), py::arg("seed"))
        ...
        .def(
            "get_qubit_count",
            [](const DensityMatrix &state) -> unsigned int {
                return (unsigned int)state.qubit_count;
            },
            "Get qubit count")
    ...
    py::class_<QuantumStateGpu, QuantumStateBase>(m, "QuantumStateGpu")
        .def(py::init<unsigned int>(), "Constructor", py::arg("qubit_count"))
        .def(py::init<unsigned int, unsigned int>(), py::arg("qubit_count"),
            py::arg("gpu_id"))
        ...
        .def("set_computational_basis",
            ...
            "Set state to computational basis", py::arg("index"))
        .def("set_Haar_random_state",
            (void(QuantumStateGpu::*)(void)) &
                QuantumStateGpu::set_Haar_random_state,
            "Set Haar random state")
        .def("set_Haar_random_state",
            (void(QuantumStateGpu::*)(UINT)) &
                QuantumStateGpu::set_Haar_random_state,
            py::arg("seed"))
        ...
        .def("load",
            ...
            "Load quantum state vector", py::arg("state"))
        .def("load",
            (void(QuantumStateGpu::*)(const std::vector<CPPCTYPE> &)) &
                QuantumStateGpu::load,
            py::arg("state"))
        ...
        .def("sampling",
            (std::vector<ITYPE>(QuantumStateGpu::*)(UINT)) &
                QuantumStateGpu::sampling,
            "Sampling measurement results", py::arg("count"))
        .def("sampling",
            (std::vector<ITYPE>(QuantumStateGpu::*)(UINT, UINT)) &
                QuantumStateGpu::sampling,
            py::arg("count"), py::arg("seed"))
        .def(
            "get_vector",
            [](const QuantumStateGpu &state) {
        ...
        .def(
            "get_qubit_count",
            [](const QuantumStateGpu &state) -> unsigned int {
                return (unsigned int)state.qubit_count;
            },
            "Get qubit count")
        .def("synchronize_update", &QuantumStateGpu::synchronize_update,
            "Synchronize update quantum state")
        .def(
            "__repr__", [](const QuantumStateGpu &p) { return p.to_string(); });
    ;
    m.def(
        "StateVectorGpu",
        [](const unsigned int qubit_count) {
    ...
    mstate.def("permutate_qubit",
        py::overload_cast<const DensityMatrix *, std::vector<UINT>>(
            &state::permutate_qubit),
        pybind11::return_value_policy::take_ownership, py::arg("state"),
        py::arg("order"));
    ...
    py::class_<QuantumGateBase>(m, "QuantumGateBase")
        ...
        .def("update_quantum_state_async",
            &QuantumGateBase::update_quantum_state_async,
            "Update quantum state async", py::arg("state"))
    ...
    mgate.def("Identity", &gate::Identity,
        pybind11::return_value_policy::take_ownership, "Create identity gate",
        py::arg("index"));
    ...
    mgate.def("Tdag", &gate::Tdag,
        pybind11::return_value_policy::take_ownership,
        "Create adjoint of pi/8-phase gate", py::arg("index"));
    mgate.def("sqrtX", &gate::sqrtX,
        pybind11::return_value_policy::take_ownership,
    ...
    mgate.def("RotInvZ", &gate::RotInvZ,
        pybind11::return_value_policy::take_ownership,
        "Create Pauli-Z rotation gate", py::arg("index"), py::arg("angle"));
    mgate.def("RotX", &gate::RotX,
        pybind11::return_value_policy::take_ownership,
        "Create Pauli-X rotation gate", py::arg("index"), py::arg("angle"));
    mgate.def("RotY", &gate::RotY,
        pybind11::return_value_policy::take_ownership,
        "Create Pauli-Y rotation gate", py::arg("index"), py::arg("angle"));
    mgate.def("RotZ", &gate::RotZ,
        pybind11::return_value_policy::take_ownership,
        "Create Pauli-Z rotation gate", py::arg("index"), py::arg("angle"));
    ...
    mgate.def(
        ...
        [](UINT control_qubit_index, UINT target_qubit_index) {
            ...
            if (ptr == NULL)
                throw std::invalid_argument("Invalid argument passed to CNOT.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership, "Create CNOT gate",
    ...
    mgate.def(
        ...
        [](UINT control_qubit_index, UINT target_qubit_index) {
            ...
            if (ptr == NULL)
                throw std::invalid_argument("Invalid argument passed to CZ.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership, "Create CZ gate",
        py::arg("control"), py::arg("target"));
    mgate.def(
        "SWAP",
        [](UINT target_index1, UINT target_index2) {
            auto ptr = gate::SWAP(target_index1, target_index2);
            if (ptr == NULL)
                throw std::invalid_argument("Invalid argument passed to SWAP.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership, "Create SWAP gate",
        py::arg("target1"), py::arg("target2"));

    mgate.def(
        "TOFFOLI",
        [](UINT control_index1, UINT control_index2, UINT target_index) {
            auto ptr = gate::X(target_index);
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to TOFFOLI.");
        ...
        pybind11::return_value_policy::take_ownership, "Create TOFFOLI gate",
        py::arg("control1"), py::arg("control2"), py::arg("target"));
    mgate.def(
        "FREDKIN",
        [](UINT control_index, UINT target_index1, UINT target_index2) {
            auto ptr = gate::SWAP(target_index1, target_index2);
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to FREDKIN.");
            auto fredkin = gate::to_matrix_gate(ptr);
            fredkin->add_control_qubit(control_index, 1);
            delete ptr;
            return fredkin;
        },
        pybind11::return_value_policy::take_ownership, "Create FREDKIN gate",
        py::arg("control"), py::arg("target1"), py::arg("target2"));

    mgate.def(
        "Pauli",
        [](std::vector<unsigned int> target_qubit_index_list,
            std::vector<unsigned int> pauli_ids) {
            ...
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to Pauli.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership,
    ...
    mgate.def(
        "PauliRotation",
        [](std::vector<unsigned int> target_qubit_index_list,
            std::vector<unsigned int> pauli_ids, double angle) {
            if (target_qubit_index_list.size() != pauli_ids.size())
                throw std::invalid_argument(
                    "Size of qubit list and pauli list must be equal.");
            auto ptr =
            ...
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to PauliRotation.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership,
    ...
    // QuantumGateMatrix*(*ptr1)(unsigned int, ComplexMatrix) =
    // &gate::DenseMatrix; QuantumGateMatrix*(*ptr2)(std::vector<unsigned int>,
    // ComplexMatrix) = &gate::DenseMatrix;
    mgate.def(
        "DenseMatrix",
        [](unsigned int target_qubit_index, ComplexMatrix matrix) {
            if (matrix.rows() != 2 || matrix.cols() != 2)
                throw std::invalid_argument("matrix dims is not 2x2.");
            auto ptr = gate::DenseMatrix(target_qubit_index, matrix);
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to DenseMatrix.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership,
        "Create dense matrix gate", py::arg("index"), py::arg("matrix"));
    mgate.def(
        "DenseMatrix",
        [](std::vector<unsigned int> target_qubit_index_list,
        ...
        pybind11::return_value_policy::take_ownership, py::arg("index_list"),
        py::arg("matrix"));
    mgate.def(
        "SparseMatrix",
        [](std::vector<unsigned int> target_qubit_index_list,
            ...
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to SparseMatrix.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership,
        "Create sparse matrix gate", py::arg("index_list"), py::arg("matrix"));
    mgate.def(
        "DiagonalMatrix",
        [](std::vector<unsigned int> target_qubit_index_list,
        ...
        pybind11::return_value_policy::take_ownership,
        "Create diagonal matrix gate", py::arg("index_list"),
        py::arg("diagonal_element"));
    ...
    mgate.def(
        ...
        [](std::vector<unsigned int> target_qubit_index_list) {
            ...
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to RandomUnitary.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership,
        "Create random unitary gate", py::arg("index_list"));
    mgate.def(
        "RandomUnitary",
        [](std::vector<unsigned int> target_qubit_index_list, UINT seed) {
    ...
    mgate.def(
        ...
        [](std::vector<UINT> target_qubit_list,
            std::function<ITYPE(ITYPE, ITYPE)> function_py) {
            auto ptr = gate::ReversibleBoolean(target_qubit_list, function_py);
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to ReversibleBoolean.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership,
    ...
    mgate.def(
        ...
        [](const QuantumStateBase *reflection_state) {
            ...
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to StateReflection.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership,
        "Create state reflection gate", py::arg("state"));

    mgate.def("BitFlipNoise", &gate::BitFlipNoise,
        pybind11::return_value_policy::take_ownership, "Create bit-flip noise",
        py::arg("index"), py::arg("prob"));
    mgate.def("DephasingNoise", &gate::DephasingNoise,
        pybind11::return_value_policy::take_ownership, "Create dephasing noise",
        py::arg("index"), py::arg("prob"));
    mgate.def("IndependentXZNoise", &gate::IndependentXZNoise,
        pybind11::return_value_policy::take_ownership,
        "Create independent XZ noise", py::arg("index"), py::arg("prob"));
    mgate.def("DepolarizingNoise", &gate::DepolarizingNoise,
        pybind11::return_value_policy::take_ownership,
        "Create depolarizing noise", py::arg("index"), py::arg("prob"));
    mgate.def(
        "TwoQubitDepolarizingNoise",
        [](UINT target_index1, UINT target_index2, double probability) {
            auto ptr = gate::TwoQubitDepolarizingNoise(
                target_index1, target_index2, probability);
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to TwoQubitDepolarizingNoise.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership,
    ...
    mgate.def("Measurement", &gate::Measurement,
        pybind11::return_value_policy::take_ownership,
        "Create measurement gate", py::arg("index"), py::arg("register"));

    QuantumGateMatrix *(*ptr3)(
        const QuantumGateBase *, const QuantumGateBase *) = &gate::merge;
    ...
    mgate.def("Probabilistic", &gate::Probabilistic,
        pybind11::return_value_policy::take_ownership,
        "Create probabilistic gate", py::arg("prob_list"),
        py::arg("gate_list"));
    ...
    mgate.def("CPTP", &gate::CPTP,
        pybind11::return_value_policy::take_ownership,
        "Create completely-positive trace preserving map",
        py::arg("kraus_list"));
    mgate.def("CP", &gate::CP, pybind11::return_value_policy::take_ownership,
    ...
    mgate.def("Adaptive",
        py::overload_cast<QuantumGateBase *,
            ...
            &gate::Adaptive),
        pybind11::return_value_policy::take_ownership, "Create adaptive gate",
        py::arg("gate"), py::arg("condition"));
    mgate.def("Adaptive",
        py::overload_cast<QuantumGateBase *,
            std::function<bool(
                const std::vector<unsigned int> &, unsigned int)>,
            unsigned int>(&gate::Adaptive),
        pybind11::return_value_policy::take_ownership, py::arg("gate"),
        py::arg("condition"), py::arg("id"));
    mgate.def("NoisyEvolution", &gate::NoisyEvolution,
        pybind11::return_value_policy::take_ownership, "Create noisy evolution",
    ...
    mgate.def(
        ...
        [](std::vector<unsigned int> target_qubit_index_list,
            std::vector<unsigned int> pauli_ids, double angle) {
            auto ptr = gate::ParametricPauliRotation(
                target_qubit_index_list, pauli_ids, angle);
            if (ptr == NULL)
                throw std::invalid_argument(
                    "Invalid argument passed to ParametricPauliRotation.");
            return ptr;
        },
        pybind11::return_value_policy::take_ownership,
    ...
    py::class_<QuantumCircuit>(m, "QuantumCircuit")
        ...
        .def("add_gate",
            (void(QuantumCircuit::*)(const QuantumGateBase *, unsigned int)) &
                QuantumCircuit::add_gate_copy,
            py::arg("gate"), py::arg("position"))
        ...
        .def(
            ...
            pybind11::return_value_policy::take_ownership, "Get gate instance",
            py::arg("position"))
        .def(
            "merge_circuit", &QuantumCircuit::merge_circuit, py::arg("circuit"))
        .def(
            "get_gate_count",
            [](const QuantumCircuit &circuit) -> unsigned int {
                return (unsigned int)circuit.gate_list.size();
            },
            "Get gate count")
        .def(
            "get_qubit_count",
        ...
        .def("update_quantum_state",
            (void(QuantumCircuit::*)(
                QuantumStateBase *, unsigned int, unsigned int)) &
                QuantumCircuit::update_quantum_state,
            py::arg("state"), py::arg("start"), py::arg("end"))
        .def("update_quantum_state_async",
            (void(QuantumCircuit::*)(QuantumStateGpu *)) &
                QuantumCircuit::update_quantum_state_async,
            "Update quantum state async", py::arg("state"))
        ...
        .def("add_multi_Pauli_gate",
            ...
            py::arg("pauli_ids"))
        .def("add_multi_Pauli_gate",
            (void(QuantumCircuit::*)(const PauliOperator &)) &
                QuantumCircuit::add_multi_Pauli_gate,
            py::arg("pauli"))
        .def("add_multi_Pauli_rotation_gate",
            (void(QuantumCircuit::*)(
                std::vector<unsigned int>, std::vector<unsigned int>, double)) &
    ...
    py::class_<ParametricQuantumCircuit, QuantumCircuit>(
        ...
        .def("add_parametric_gate",
            (void(ParametricQuantumCircuit::*)(
                QuantumGate_SingleParameter * gate, UINT)) &
                ParametricQuantumCircuit::add_parametric_gate_copy,
            py::arg("gate"), py::arg("position"))
        .def("add_gate",
            (void(ParametricQuantumCircuit::*)(const QuantumGateBase *gate)) &
                ParametricQuantumCircuit::add_gate_copy,
            "Add gate", py::arg("gate"))
        .def("add_gate",
            (void(ParametricQuantumCircuit::*)(
                const QuantumGateBase *gate, unsigned int)) &
                ParametricQuantumCircuit::add_gate_copy,
            py::arg("gate"), py::arg("position"))
    ...
    py::class_<QuantumCircuitOptimizer>(mcircuit, "QuantumCircuitOptimizer")
        ...
        .def("merge_all", &QuantumCircuitOptimizer::merge_all,
            pybind11::return_value_policy::take_ownership, py::arg("circuit"));
    ...
    py::class_<CausalConeSimulator>(m, "CausalConeSimulator")
        .def(
            py::init<ParametricQuantumCircuit &, Observable &>(), "Constructor")
